...
public class GoogleUtil {
	...
	private static Logger logger = (Logger) LoggerFactory.getLogger(GoogleUtil.class);
	private static final String googleId="1084118794615-e2ur2memhesr07o5abqi5m55j449aur2.apps.googleusercontent.com";
	private static final String secreateKey="AIzaSyAHlPrdLciZUGhyGqYFo01nG7EVdPGQWas";
